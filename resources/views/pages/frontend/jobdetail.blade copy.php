            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="card job-detail overflow-hidden">
                        {{-- @foreach ($loker->file as $file)
                            <div>
                                <img src="{{ asset($file->filepath) }}" alt="" class="img-fluid">
                                <div class="job-details-compnay-profile">
                                    <img src="{{ asset('assets/images/featured-job/img-10.png') }}" alt="" class="img-fluid rounded-3 rounded-3">
                                </div>
                            </div>
                        @endforeach --}}
                            ...
                            <div class="mt-4">
                                ...
                                <div class="job-detail-desc mt-2">
                                    <ul class="job-detail-list list-unstyled mb-0 text-muted">
                                        <li><i class="uil uil-circle"></i> {{ $loker->qualification }}</li> 
                                        <li><i class="uil uil-circle"></i> Usia maksimal 20 th</li> 
                                        <li><i class="uil uil-circle"></i> Sudah Vaksin booster</li> 
                                        <li><i class="uil uil-circle"></i> Sehat jasmani dan rohani</li> 
                                    </ul>
                                </div>
                            </div>
                            <div class="mt-3">
                                <div class="row justify-content-center">
                                <a href="#applyNow" data-bs-toggle="modal" class="btn btn-primary btn-hover w-25 mt-2">Apply Now <i class="uil uil-arrow-right"></i></a>
                                </div>
                            </div>
